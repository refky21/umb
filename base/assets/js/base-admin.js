jQuery(document).ready(function($) {
	...
	$('.input-yes-no').parent('.iPhoneCheckContainer').find('.iPhoneCheckLabelOff > span').text('NO');
	$('.input-yes-no').parent('.iPhoneCheckContainer').find('.iPhoneCheckLabelOn > span').text('YES');

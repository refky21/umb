    ...
    foreach ($repeat_fields as $opt){
      ...
      case 'wp_editor': ?>
        <div class="elementContent">
          ...
          <div class="contentMetaDesc wpeditorContentMetaDesc" data-wp-editor-id="<?php echo $id ?>-<?php echo $count_repeat ?>-<?php echo $opt['id'] ?>" data-wp-editor-name="<?php echo $field_id ?>">
            <textarea class="wpeditorTinyMCE" id="<?php echo $id ?>-<?php echo $count_repeat ?>-<?php echo $opt['id'] ?>" name="<?php echo $field_id ?>" style="min-height: 200px;"><?php echo isset($value_field)? $value_field : '' ?></textarea>
          </div>
          <?php 
            if(isset($opt['desc'])) {
              echo '<p class="metaboxDescription">'.$opt['desc'].'</p>';
